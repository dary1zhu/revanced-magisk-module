...
DEF_PATCHES_VER="${NEXT_VER_CODE:-$(toml_get "$main_config_t" patches-version)}" || DEF_PATCHES_VER="latest"
DEF_CLI_VER="${NEXT_VER_CODE:-$(toml_get "$main_config_t" cli-version)}" || DEF_CLI_VER="latest"
...
for table_name in $(toml_get_table_names); do
	...
	cli_ver=$(toml_get "$t" cli-version) || cli_ver="latest"
